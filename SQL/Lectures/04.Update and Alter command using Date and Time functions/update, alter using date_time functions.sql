...
-- dataset - ONLINE RETAIL (3).XLSX - ONLINE RETAIL.CSV
-- TASK - INSERT THE DATA INTO THE TABLE
...
-- dump bulk data into table
LOAD DATA INFILE
'F:/INEURON_SQL/UPDATE_ALTER/ONLINE RETAIL (3).XLSX - ONLINE RETAIL.CSV'
